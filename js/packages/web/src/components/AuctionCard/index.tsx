          ...
          <Route
            ...
            render={({ history }) => {
              ...
              const instantSale = async () => {
                ...
                console.log({
                  allowBidToPublic,allowBidToAuctionOwner,myPayingAccount,isAuctionItemMaster,winningConfigType,instantSalePrice,accountByMint
                })
                if (
                  instantSalePrice &&
                ...
                console.log({auctionView,prizeTrackingTickets,bidRedemptions,bids});
                // Claim the purchase
                try {
                  await sendRedeemBid(
                    connection,
