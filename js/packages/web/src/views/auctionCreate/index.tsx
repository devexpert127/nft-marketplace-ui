...
export const AuctionCreateView = () => {
  ...
  const createAuction = async () => {
    ...
    const participationSafetyDepositDraft = isOpenEdition
      ...
      console.log({whitelistedCreatorsByCreator, winnerLimit,isOpenEdition ,auctionSettings,safetyDepositDrafts,participationSafetyDepositDraft,quoteMint: QUOTE_MINT.toBase58()})
